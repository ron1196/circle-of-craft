...
import io.github.ron1196.circleofcraft.entity.hostile.SkeletalHyenaHeadEntity;
import java.util.EnumSet;
import net.minecraft.world.entity.LivingEntity;
import net.minecraft.world.entity.ai.goal.Goal;

/**
 * Custom hop goal that makes the skeletal hyena head jump toward its target, matching the old mod's
 * slime-like bouncing behavior.
 */
