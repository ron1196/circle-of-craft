...
public class TimonPumbaaLodgeFeature extends Feature<NoneFeatureConfiguration> {
    ...
    public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
        ...
        BlockState log = ModBlocks.MANGO_LOG.get().defaultBlockState();
        BlockState planks = ModBlocks.MANGO_PLANKS.get().defaultBlockState();
        BlockState leaves = ModBlocks.MANGO_LEAVES.get().defaultBlockState().setValue(LeavesBlock.PERSISTENT, true);
