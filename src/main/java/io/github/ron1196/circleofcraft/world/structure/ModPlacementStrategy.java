 ...
 */
public abstract class ModPlacementStrategy {
    ...
    private static class Registry {
        static final ModPlacementStrategy DEFAULT = new NoFluidStrategy();

        static final Map<String, ModPlacementStrategy> STRATEGIES = Map.of(
    ...
    static ModPlacementStrategy forStructure(String path) {
    ...
    static class FourCornersStrategy extends ModPlacementStrategy {
    ...
    static class AboveSeaLevelStrategy extends ModPlacementStrategy {
        @Override
        boolean isValid(GenerationContext context, int x, int y, int z) {
    ...
    static class NoFluidStrategy extends ModPlacementStrategy {
        @Override
        boolean isValid(GenerationContext context, int x, int y, int z) {
