...
public class LilyPadFeature extends Feature<NoneFeatureConfiguration> {
    ...
    public LilyPadFeature(Codec<NoneFeatureConfiguration> codec) {
        super(codec);
        VARIANTS[0] = ModBlocks.LILY_RED.get().defaultBlockState();
        VARIANTS[1] = ModBlocks.LILY_VIOLET.get().defaultBlockState();
        VARIANTS[2] = ModBlocks.LILY_WHITE.get().defaultBlockState();
    }
    ...
    private boolean canPlaceLily(WorldGenLevel level, BlockPos waterPos, BlockPos lilyPos, BlockState lily) {
