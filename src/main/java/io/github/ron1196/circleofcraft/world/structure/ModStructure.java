 ...
 * building is done by ModStructurePiece which delegates to existing Feature classes.
 */
public class ModStructure extends Structure {
    ...
    public ModStructure(StructureSettings settings, ResourceLocation featureId) {
        super(settings);
    ...
    protected @NotNull Optional<GenerationStub> findGenerationPoint(GenerationContext context) {
        ...
        return Optional.of(new GenerationStub(pos, builder -> builder.addPiece(new ModStructurePiece(pos, featureId))));
    }

    private boolean isValidPlacement(GenerationContext context, String path, int x, int y, int z) {
        return ModPlacementStrategy.forStructure(path).isValid(context, x, y, z);
    }
