...
public class Features {
    ...
    public static final DeferredRegister<Feature<?>> FEATURES =
            DeferredRegister.create(Registries.FEATURE, CircleOfCraftMod.MOD_ID);

    // ── Helper ─────────────────────────────────────────────────────────────

    private static DeferredHolder<Feature<?>, Feature<NoneFeatureConfiguration>> register(
    ...
    public static final DeferredHolder<Feature<?>, Feature<NoneFeatureConfiguration>> BANANA_TREE =
            register("banana_tree", BananaTreeFeature::new);
    public static final DeferredHolder<Feature<?>, Feature<NoneFeatureConfiguration>> DEAD_TREE =
            register("dead_tree", DeadTreeFeature::new);
    public static final DeferredHolder<Feature<?>, Feature<NoneFeatureConfiguration>> RAINFOREST_TREE =
            register("rainforest_tree", RainforestTreeFeature::new);
    public static final DeferredHolder<Feature<?>, Feature<NoneFeatureConfiguration>> MANGO_TREE =
            register("mango_tree", MangoTreeFeature::new);
    public static final DeferredHolder<Feature<?>, Feature<NoneFeatureConfiguration>> PASSION_TREE =
            register("passion_tree", PassionTreeFeature::new);

    // ── Structures ─────────────────────────────────────────────────────────

    public static final DeferredHolder<Feature<?>, Feature<NoneFeatureConfiguration>> TERMITE_MOUND =
            register("termite_mound", TermiteMoundFeature::new);
    public static final DeferredHolder<Feature<?>, Feature<NoneFeatureConfiguration>> RAFIKI_TREE =
            register("rafiki_tree", RafikiTreeFeature::new);
    public static final DeferredHolder<Feature<?>, Feature<NoneFeatureConfiguration>> ZIRA_MOUND =
            register("zira_mound", ZiraMoundFeature::new);
    public static final DeferredHolder<Feature<?>, Feature<NoneFeatureConfiguration>> TICKET_BOOTH =
            register("ticket_booth", TicketBoothFeature::new);
    public static final DeferredHolder<Feature<?>, Feature<NoneFeatureConfiguration>> TIMON_PUMBAA_LODGE =
            register("timon_pumbaa_lodge", TimonPumbaaLodgeFeature::new);
    public static final DeferredHolder<Feature<?>, Feature<NoneFeatureConfiguration>> TREASURE_MOUND =
            register("treasure_mound", TreasureMoundFeature::new);
    public static final DeferredHolder<Feature<?>, Feature<NoneFeatureConfiguration>> LILY_PAD =
            register("lily_pad", LilyPadFeature::new);
    public static final DeferredHolder<Feature<?>, Feature<NoneFeatureConfiguration>> DUNGEON =
            register("dungeon", DungeonFeature::new);

    public static final DeferredHolder<Feature<?>, Feature<NoneFeatureConfiguration>> FALLEN_PRIDE_ACACIA_LOG =
            register("fallen_pride_acacia_log", c -> new FallenLogFeature(c, ModBlocks.FALLEN_PRIDE_ACACIA_LOG));
    public static final DeferredHolder<Feature<?>, Feature<NoneFeatureConfiguration>> FALLEN_RAINFOREST_LOG =
            register("fallen_rainforest_log", c -> new FallenLogFeature(c, ModBlocks.FALLEN_RAINFOREST_LOG));
    public static final DeferredHolder<Feature<?>, Feature<NoneFeatureConfiguration>> FALLEN_MANGO_LOG =
            register("fallen_mango_log", c -> new FallenLogFeature(c, ModBlocks.FALLEN_MANGO_LOG));
    public static final DeferredHolder<Feature<?>, Feature<NoneFeatureConfiguration>> FALLEN_BANANA_LOG =
