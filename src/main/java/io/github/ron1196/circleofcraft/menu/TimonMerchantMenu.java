package io.github.ron1196.circleofcraft.menu;
...
public class TimonMerchantMenu extends AbstractContainerMenu {
    ...
    public static final String TITLE_KEY = "container.circleofcraft.timon_merchant";
    ...
    private static final List<TradeEntry> TRADES = List.of(
            new TradeEntry(ModItems.TUNNAH_DIGGAH, 5),
            new TradeEntry(ModItems.PUMBAA_BOMB, 6),
            new TradeEntry(ModItems.CRYSTAL, 7),
            new TradeEntry(ModItems.EXPERIENCE_GRUB, 4),
            new TradeEntry(ModItems.AMULET, 10));
