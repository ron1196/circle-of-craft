 ...
 * </ul>
 *
 * <p>A separate test pins the {@code /lk quest reset} contract: after reset, the first stage's
...
public class RafikiQuestActionsGameTests {
    ...
    /**
     * Documents the {@code /lk quest reset} contract: after reset, calling ensureWorldState with
    ...
    public void questResetFirstStageDiscardsScar(GameTestHelper helper) {
        ...
        assertScarCount(helper, 0, "after /lk quest reset rafiki, world state must match first stage");
        helper.succeed();
    }
