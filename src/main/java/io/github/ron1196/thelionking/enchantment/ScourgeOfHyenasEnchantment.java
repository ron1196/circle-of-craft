...
public class ScourgeOfHyenasEnchantment extends Enchantment {
    ...
    /**
     * Returns the bonus damage against a specific entity.
     * This is checked by calling code to add extra damage to hyena-type mobs.
     * Since Enchantment doesn't have a built-in per-entity getDamageBonus override,
     * we expose this as a utility method to be called from an event handler.
     */
