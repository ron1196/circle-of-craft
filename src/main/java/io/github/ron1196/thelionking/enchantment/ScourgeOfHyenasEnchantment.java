...
public class ScourgeOfHyenasEnchantment extends Enchantment {
  ...
  public ScourgeOfHyenasEnchantment() {
    super(
        Rarity.UNCOMMON, EnchantmentCategory.WEAPON, new EquipmentSlot[] {EquipmentSlot.MAINHAND});
  }
   ...
   */
  public static float getBonusDamageForEntity(
      int level, net.minecraft.world.entity.LivingEntity target) {
