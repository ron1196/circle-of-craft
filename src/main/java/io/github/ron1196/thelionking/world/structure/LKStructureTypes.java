...
public class LKStructureTypes {
    ...
    public static final RegistryObject<StructureType<LKCodeStructure>> LK_CODE_STRUCTURE =
            STRUCTURE_TYPES.register("lk_code_structure", () -> () -> LKCodeStructure.CODEC);

    public static final RegistryObject<StructurePieceType> LK_PIECE_TYPE =
            STRUCTURE_PIECE_TYPES.register("lk_code_piece", () -> LKStructurePiece::new);
}
