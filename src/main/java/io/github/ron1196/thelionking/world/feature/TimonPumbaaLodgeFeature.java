...
public class TimonPumbaaLodgeFeature extends Feature<NoneFeatureConfiguration> {
  ...
  public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
    ...
    FeatureHelper.spawnEntity(
        level, EntityTypes.TIMON.get(), pos.getX() + 2.5, pos.getY() + 1, pos.getZ() + 2.5);
    FeatureHelper.spawnEntity(
        level, EntityTypes.PUMBAA.get(), pos.getX() + 1.5, pos.getY() + 1, pos.getZ() + 2.5);
