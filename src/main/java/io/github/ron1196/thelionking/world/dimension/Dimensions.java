...
public class Dimensions {
    ...
    private static ResourceKey<Level> levelKey(String path) {
        return ResourceKey.create(Registries.DIMENSION, new ResourceLocation(TheLionKingMod.MOD_ID, path));
    }

    private static ResourceKey<DimensionType> typeKey(String path) {
        return ResourceKey.create(Registries.DIMENSION_TYPE, new ResourceLocation(TheLionKingMod.MOD_ID, path));
    }
}
