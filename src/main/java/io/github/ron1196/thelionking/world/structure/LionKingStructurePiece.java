...
public class LionKingStructurePiece extends StructurePiece {

  private static final Logger LOGGER = LoggerFactory.getLogger(LionKingStructurePiece.class);
  ...
  private static final Map<String, StructureConfig> CONFIGS =
      Map.of(
  ...
  public LionKingStructurePiece(BlockPos pos, ResourceLocation featureId) {
    super(StructureTypes.LK_PIECE_TYPE.get(), 0, computeBoundingBox(pos, featureId));
    this.featureId = featureId;
  }

  public LionKingStructurePiece(StructurePieceSerializationContext ctx, CompoundTag tag) {
  ...
  protected void addAdditionalSaveData(
      @NotNull StructurePieceSerializationContext ctx, CompoundTag tag) {
