...
/**
 * Strategy pattern for validating structure placement terrain. Each subclass encapsulates a
 * different validation approach.
 */
public abstract class LionKingPlacementStrategy {
    ...
    private static class Registry {
        static final LionKingPlacementStrategy DEFAULT = new NoFluidStrategy();

        static final Map<String, LionKingPlacementStrategy> STRATEGIES = Map.of(
    ...
    static LionKingPlacementStrategy forStructure(String path) {
    ...
    static class FourCornersStrategy extends LionKingPlacementStrategy {
    ...
    static class AboveSeaLevelStrategy extends LionKingPlacementStrategy {
        @Override
        boolean isValid(GenerationContext context, int x, int y, int z) {
    ...
    static class NoFluidStrategy extends LionKingPlacementStrategy {
        @Override
        boolean isValid(GenerationContext context, int x, int y, int z) {
