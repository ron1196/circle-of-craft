...
public class ClientEvents {
  ...
  // Keybinds
  public static final KeyMapping SIMBA_SIT_KEY =
      new KeyMapping(
  ...
  public static void registerRenderers(EntityRenderersEvent.RegisterRenderers event) {
    ...
    event.registerEntityRenderer(
        ...
        ctx ->
            new AnimalRenderer<>(
                ctx, new LionModel<>(ctx.bakeLayer(LIONESS_LAYER)), "lioness", 0.6F));
    event.registerEntityRenderer(
        EntityTypes.ZEBRA.get(),
        ctx ->
            new AnimalRenderer<>(ctx, new ZebraModel<>(ctx.bakeLayer(ZEBRA_LAYER)), "zebra", 0.7F));
    event.registerEntityRenderer(
    ...
    event.registerEntityRenderer(
        ...
        ctx ->
            new AnimalRenderer<>(ctx, new RhinoModel<>(ctx.bakeLayer(RHINO_LAYER)), "rhino", 0.9F));
    event.registerEntityRenderer(
        EntityTypes.GEMSBOK.get(),
        ctx ->
            new AnimalRenderer<>(
                ctx, new GemsbokModel<>(ctx.bakeLayer(GEMSBOK_LAYER)), "gemsbok", 0.6F));
    event.registerEntityRenderer(
    ...
    event.registerEntityRenderer(
        ...
        ctx ->
            new AnimalRenderer<>(
                ctx, new FlamingoModel<>(ctx.bakeLayer(FLAMINGO_LAYER)), "flamingo", 0.3F));
    event.registerEntityRenderer(
        EntityTypes.ZAZU.get(),
        ctx ->
            new AnimalRenderer<>(ctx, new ZazuModel<>(ctx.bakeLayer(ZAZU_LAYER)), "zazu", 0.25F));
    event.registerEntityRenderer(
        EntityTypes.BUG.get(),
    ...
    event.registerEntityRenderer(
        ...
        ctx ->
            new MobRenderer<>(
                ctx,
                new HyenaModel<>(ctx.bakeLayer(SKELETAL_HYENA_LAYER)),
                "skeletal_hyena",
                0.5F));
    event.registerEntityRenderer(
    ...
    event.registerEntityRenderer(
        ...
        ctx ->
            new MobRenderer<>(
                ctx, new VultureModel<>(ctx.bakeLayer(VULTURE_LAYER)), "vulture", 0.5F));
    event.registerEntityRenderer(
        EntityTypes.CROCODILE.get(),
        ctx ->
            new MobRenderer<>(
                ctx, new CrocodileModel<>(ctx.bakeLayer(CROCODILE_LAYER)), "crocodile", 0.7F));
    event.registerEntityRenderer(
        EntityTypes.TERMITE.get(),
        ctx ->
            new ScaledMobRenderer<>(
    ...
    event.registerEntityRenderer(
        ...
        ctx ->
            new ScaledMobRenderer<>(
                ctx,
                new TermiteModel<>(ctx.bakeLayer(TERMITE_QUEEN_LAYER)),
                "termite",
                0.7F,
                1.7F));
    ...
    event.registerEntityRenderer(
        ...
        ctx ->
            new NpcRenderer(
                ctx, new RafikiModel(ctx.bakeLayer(RAFIKI_LAYER)), "rafiki", 0.35F, 0.5F));
    event.registerEntityRenderer(
        EntityTypes.SIMBA.get(),
        ctx ->
            new NpcRenderer(ctx, new SimbaModel(ctx.bakeLayer(SIMBA_LAYER)), "simba", 0.5F, 0.5F));
    event.registerEntityRenderer(
        EntityTypes.TIMON.get(),
        ctx ->
            new NpcRenderer(ctx, new TimonModel(ctx.bakeLayer(TIMON_LAYER)), "timon", 0.2F, 0.5F));
    event.registerEntityRenderer(
    ...
    event.registerEntityRenderer(
        ...
        ctx ->
            new NpcRenderer(ctx, new NpcLionModel(ctx.bakeLayer(ZIRA_LAYER)), "zira", 0.5F, 0.5F));
    ...
    event.registerEntityRenderer(
        ...
        ctx ->
            new NpcRenderer(
                ctx, new NpcLionModel(ctx.bakeLayer(TICKET_LION_LAYER)), "ticket_lion", 0.7F));
    ...
    // Projectiles
    event.registerEntityRenderer(
        EntityTypes.DART.get(),
        ctx ->
            new net.minecraft.client.renderer.entity.ArrowRenderer<>(ctx) {
    ...
    // LightningBolt
    event.registerEntityRenderer(
        EntityTypes.LK_LIGHTNING_BOLT.get(),
        net.minecraft.client.renderer.entity.LightningBoltRenderer::new);

    // Block entity renderers
    event.registerBlockEntityRenderer(
        BlockEntityTypes.HYENA_HEAD.get(), HyenaHeadBlockEntityRenderer::new);
