...
/**
 * Breeding goal that is suppressed when the animal is angry. Intended for NeutralMob animals (e.g.,
 * rhinos, gemsboks) that won't breed while they have a revenge target.
 */
