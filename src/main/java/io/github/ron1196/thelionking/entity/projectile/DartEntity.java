...
public class DartEntity extends AbstractArrow implements net.minecraft.world.entity.projectile.ItemSupplier {
    ...
    protected @NotNull ItemStack getPickupItem() {
        return switch (getDartType()) {
            case BLUE -> new ItemStack(LionKingItems.DART_BLUE.get());
            case RED -> new ItemStack(LionKingItems.DART_RED.get());
            case YELLOW -> new ItemStack(LionKingItems.DART_YELLOW.get());
            case PINK -> new ItemStack(LionKingItems.DART_PINK.get());
            case BLACK -> new ItemStack(LionKingItems.DART_BLACK.get());
        };
    }
}
