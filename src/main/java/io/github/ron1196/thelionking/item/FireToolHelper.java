 ...
 * When mining a block that has a furnace recipe, drops the smelted result instead.
 */
public final class FireToolHelper {
    ...
    /**
     * Attempts auto-smelt on block break. Returns true if the block was auto-smelted
     * (caller should cancel normal drop logic).
     */
