...
public class LionKingToolTiers {
  ...
  public static final ForgeTier PRIDESTONE =
      new ForgeTier(
          1,
          150,
          4.0F,
          ...
          () -> Ingredient.of(Items.PRIDESTONE_ITEM.get()));

  public static final ForgeTier SILVER =
      new ForgeTier(
          2,
          490,
          6.0F,
  ...
  public static final ForgeTier PEACOCK =
      new ForgeTier(
          3,
          1475,
          8.0F,
  ...
  public static final ForgeTier KIVULITE =
      new ForgeTier(
          ...
          3,
          BlockTags.NEEDS_IRON_TOOL,
          () -> Ingredient.of(Items.KIVULITE.get()));

  public static final ForgeTier CORRUPT_PRIDESTONE =
      new ForgeTier(
          1,
          120,
          5.5F,
