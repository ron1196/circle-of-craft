...
public class OutlandsQuestline {
  ...
  public static Questline build() {
    return Questline.builder("outlands")
        ...
        .stage(
            FIND_ZIRA,
            new io.github.ron1196.thelionking.quest.stage.Stage("Find Zira in the Outlands"))
        .stage(
            COLLECT_INGOTS,
        ...
        .stage(
            FOLLOW_OUTLANDERS,
            new io.github.ron1196.thelionking.quest.stage.Stage("Follow the Outlanders"))
        .stage(
            STAGE_6,
            new io.github.ron1196.thelionking.quest.stage.Stage("Continue exploring the Outlands"))
        .stage(
            STAGE_7,
            new io.github.ron1196.thelionking.quest.stage.Stage("Continue exploring the Outlands"))
        .stage(
