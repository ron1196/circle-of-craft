...
public class RafikiQuestline {
  ...
  public static Questline build() {
    return Questline.builder("rafiki")
        ...
        .stage(
            FIND_RAFIKI,
            new io.github.ron1196.thelionking.quest.stage.Stage("Find Rafiki and speak to him"))
        .stage(
            COLLECT_BONES,
            new io.github.ron1196.thelionking.quest.stage.Stage(
                "Bring Rafiki 64 hyena bones", List.of(new ItemRequirement(Items.HYENA_BONE, 64))))
        .stage(DEFEAT_SCAR, new io.github.ron1196.thelionking.quest.stage.Stage("Defeat Scar"))
        .stage(
            RETURN_AFTER_SCAR,
            new io.github.ron1196.thelionking.quest.stage.Stage("Return to Rafiki"))
        .stage(
            COLLECT_TERMITES,
            new io.github.ron1196.thelionking.quest.stage.Stage(
        ...
        .stage(
            COLLECT_MANGOES,
            new io.github.ron1196.thelionking.quest.stage.Stage(
                "Bring Rafiki 4 ground mangoes", List.of(new ItemRequirement(Items.MANGO_DUST, 4))))
        .stage(
            USE_STAR_ALTAR,
            new io.github.ron1196.thelionking.quest.stage.Stage(
