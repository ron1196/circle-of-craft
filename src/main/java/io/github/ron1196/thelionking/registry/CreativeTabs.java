    ...
    public static final RegistryObject<CreativeModeTab> BLOCKS_TAB =
            TABS.register("blocks", () -> CreativeModeTab.builder()
                    ...
                    .displayItems((params, output) -> {
                        ...
                        output.accept(LionKingItems.OAK_BUG_TRAP_ITEM.get());
                        output.accept(LionKingItems.SPRUCE_BUG_TRAP_ITEM.get());
                        output.accept(LionKingItems.BIRCH_BUG_TRAP_ITEM.get());
                        output.accept(LionKingItems.JUNGLE_BUG_TRAP_ITEM.get());
                        output.accept(LionKingItems.ACACIA_BUG_TRAP_ITEM.get());
                        output.accept(LionKingItems.DARK_OAK_BUG_TRAP_ITEM.get());
                        output.accept(LionKingItems.MANGROVE_BUG_TRAP_ITEM.get());
                        output.accept(LionKingItems.CHERRY_BUG_TRAP_ITEM.get());
                        output.accept(LionKingItems.BAMBOO_BUG_TRAP_ITEM.get());
                        output.accept(LionKingItems.CRIMSON_BUG_TRAP_ITEM.get());
                        output.accept(LionKingItems.WARPED_BUG_TRAP_ITEM.get());
                        output.accept(LionKingItems.BANANA_BUG_TRAP_ITEM.get());
                        output.accept(LionKingItems.RAINFOREST_BUG_TRAP_ITEM.get());
                        output.accept(LionKingItems.MANGO_BUG_TRAP_ITEM.get());
                        output.accept(LionKingItems.PASSION_BUG_TRAP_ITEM.get());
