...
public class LionKingBlocks {
  ...
  // ========== Pridestone & Variants ==========
  public static final RegistryObject<Block> PRIDESTONE =
      BLOCKS.register(
          "pridestone",
          () ->
              new Block(
  ...
  public static final RegistryObject<Block> CORRUPT_PRIDESTONE =
      BLOCKS.register(
          "corrupt_pridestone",
          () ->
              new Block(
  ...
  public static final RegistryObject<Block> PRIDE_BRICK =
      BLOCKS.register(
          "pride_brick",
          () ->
              new Block(
  ...
  public static final RegistryObject<Block> MOSSY_PRIDE_BRICK =
      BLOCKS.register(
          "mossy_pride_brick",
          () ->
              new Block(
  ...
  // ========== Wood - Acacia ==========
  public static final RegistryObject<Block> ACACIA_LOG =
      BLOCKS.register(
          "pride_acacia_log",
          () ->
              new RotatedPillarBlock(
  ...
  public static final RegistryObject<Block> ACACIA_PLANKS =
      BLOCKS.register(
          "pride_acacia_planks",
          () ->
              new Block(
  ...
  public static final RegistryObject<StairBlock> ACACIA_STAIRS =
      BLOCKS.register(
          "pride_acacia_stairs",
          () ->
              new StairBlock(
  ...
  public static final RegistryObject<SlabBlock> ACACIA_SLAB =
      BLOCKS.register(
          "pride_acacia_slab",
          () -> new SlabBlock(BlockBehaviour.Properties.copy(ACACIA_PLANKS.get())));

  // ========== Wood - Rainforest ==========
  public static final RegistryObject<Block> RAINFOREST_LOG =
      BLOCKS.register(
          "rainforest_log",
          () ->
              new RotatedPillarBlock(
  ...
  public static final RegistryObject<Block> RAINFOREST_PLANKS =
      BLOCKS.register(
          "rainforest_planks",
          () ->
              new Block(
  ...
  public static final RegistryObject<StairBlock> RAINFOREST_STAIRS =
      BLOCKS.register(
          "rainforest_stairs",
          () ->
              new StairBlock(
  ...
  public static final RegistryObject<SlabBlock> RAINFOREST_SLAB =
      BLOCKS.register(
          "rainforest_slab",
          () -> new SlabBlock(BlockBehaviour.Properties.copy(RAINFOREST_PLANKS.get())));

  // ========== Wood - Mango ==========
  public static final RegistryObject<Block> MANGO_LOG =
      BLOCKS.register(
          "mango_log",
          () ->
              new RotatedPillarBlock(
  ...
  public static final RegistryObject<Block> MANGO_PLANKS =
      BLOCKS.register(
          "mango_planks",
          () ->
              new Block(
  ...
  public static final RegistryObject<StairBlock> MANGO_STAIRS =
      BLOCKS.register(
          "mango_stairs",
          () ->
              new StairBlock(
                  () -> MANGO_PLANKS.get().defaultBlockState(),
                  BlockBehaviour.Properties.copy(MANGO_PLANKS.get())));

  public static final RegistryObject<SlabBlock> MANGO_SLAB =
      BLOCKS.register(
          "mango_slab", () -> new SlabBlock(BlockBehaviour.Properties.copy(MANGO_PLANKS.get())));

  // ========== Wood - Passion ==========
  public static final RegistryObject<Block> PASSION_LOG =
      BLOCKS.register(
          "passion_log",
          () ->
              new RotatedPillarBlock(
  ...
  public static final RegistryObject<Block> PASSION_PLANKS =
      BLOCKS.register(
          "passion_planks",
          () ->
              new Block(
  ...
  public static final RegistryObject<StairBlock> PASSION_STAIRS =
      BLOCKS.register(
          "passion_stairs",
          () ->
              new StairBlock(
  ...
  // ========== Wood - Banana ==========
  public static final RegistryObject<Block> BANANA_LOG =
      BLOCKS.register(
          "banana_log",
          () ->
              new RotatedPillarBlock(
  ...
  public static final RegistryObject<Block> BANANA_PLANKS =
      BLOCKS.register(
          "banana_planks",
          () ->
              new Block(
  ...
  public static final RegistryObject<StairBlock> BANANA_STAIRS =
      BLOCKS.register(
          "banana_stairs",
          () ->
              new StairBlock(
  ...
  public static final RegistryObject<SlabBlock> BANANA_SLAB =
      BLOCKS.register(
          "banana_slab", () -> new SlabBlock(BlockBehaviour.Properties.copy(BANANA_PLANKS.get())));
  ...
  public static final RegistryObject<StairBlock> DEADWOOD_STAIRS =
      BLOCKS.register(
          "deadwood_stairs",
          () ->
              new StairBlock(
  ...
  public static final RegistryObject<SlabBlock> DEADWOOD_SLAB =
      BLOCKS.register(
          "deadwood_slab",
          () -> new SlabBlock(BlockBehaviour.Properties.copy(DEADWOOD_PLANKS.get())));

  // ========== Stone Stairs & Slabs ==========
  public static final RegistryObject<StairBlock> PRIDESTONE_STAIRS =
      BLOCKS.register(
          "pridestone_stairs",
          () ->
              new StairBlock(
                  () -> PRIDESTONE.get().defaultBlockState(),
                  BlockBehaviour.Properties.copy(PRIDESTONE.get())));

  public static final RegistryObject<SlabBlock> PRIDESTONE_SLAB =
      BLOCKS.register(
          "pridestone_slab", () -> new SlabBlock(BlockBehaviour.Properties.copy(PRIDESTONE.get())));

  public static final RegistryObject<StairBlock> PRIDE_BRICK_STAIRS =
      BLOCKS.register(
          "pride_brick_stairs",
          () ->
              new StairBlock(
                  () -> PRIDE_BRICK.get().defaultBlockState(),
  ...
  public static final RegistryObject<WallBlock> PRIDESTONE_WALL =
      BLOCKS.register(
          "pridestone_wall", () -> new WallBlock(BlockBehaviour.Properties.copy(PRIDESTONE.get())));
  ...
  public static final RegistryObject<WallBlock> CORRUPT_PRIDESTONE_WALL =
      BLOCKS.register(
          "corrupt_pridestone_wall",
          () -> new WallBlock(BlockBehaviour.Properties.copy(CORRUPT_PRIDESTONE.get())));

  // ========== Redstone ==========
  public static final RegistryObject<PressurePlateBlock> PRIDESTONE_PRESSURE_PLATE =
      BLOCKS.register(
  ...
  public static final RegistryObject<ButtonBlock> PRIDESTONE_BUTTON =
      BLOCKS.register(
          "pridestone_button",
          () ->
              new ButtonBlock(
  ...
  // ========== Misc Blocks ==========
  public static final RegistryObject<Block> DRIED_MAIZE_BLOCK =
      BLOCKS.register(
          "dried_maize_block",
          () ->
              new Block(
  ...
  public static final RegistryObject<StairBlock> DRIED_MAIZE_STAIRS =
      BLOCKS.register(
          "dried_maize_stairs",
          () ->
              new StairBlock(
  ...
  public static final RegistryObject<SlabBlock> DRIED_MAIZE_SLAB =
      BLOCKS.register(
          "dried_maize_slab",
          () -> new SlabBlock(BlockBehaviour.Properties.copy(DRIED_MAIZE_BLOCK.get())));

  public static final RegistryObject<Block> OUTSAND =
      BLOCKS.register(
          "outsand",
          () ->
              new OutsandBlock(
  ...
  public static final RegistryObject<Block> OUTGLASS =
      BLOCKS.register(
          "outglass",
          () ->
              new GlassBlock(
  ...
  public static final RegistryObject<IronBarsBlock> OUTGLASS_PANE =
      BLOCKS.register(
          "outglass_pane",
          () ->
              new IronBarsBlock(
  ...
  public static final RegistryObject<Block> TERMITE_MOUND =
      BLOCKS.register(
          "termite_mound",
          () ->
  ...
  public static final RegistryObject<Block> ZIRA_MOUND_GATE =
      BLOCKS.register(
          "zira_mound_gate",
          () ->
              new ZiraMoundGateBlock(
                  BlockBehaviour.Properties.of()
                      .mapColor(MapColor.DIRT)
                      .strength(-1.0F, 3600000.0F)
                      .noLootTable()));

  public static final RegistryObject<Block> PUMBAA_BOX =
      BLOCKS.register(
          "pumbaa_box",
          () ->
              new Block(
  ...
  public static final RegistryObject<LeavesBlock> PASSION_LEAVES =
      BLOCKS.register(
  ...
  public static final RegistryObject<LeavesBlock> RAFIKI_LEAVES =
      BLOCKS.register(
          "rafiki_leaves",
          () -> new LionKingLeavesBlock(leavesProperties().strength(-1.0F, 3600000.0F)));
  ...
  public static final RegistryObject<Block> ACACIA_SAPLING =
      BLOCKS.register(
          "pride_acacia_sapling",
          () -> new LionKingSaplingBlock(TreeGrowers.ACACIA, saplingProperties()));

  public static final RegistryObject<Block> RAINFOREST_SAPLING =
      BLOCKS.register(
          "rainforest_sapling",
          () -> new LionKingSaplingBlock(TreeGrowers.RAINFOREST, saplingProperties()));

  public static final RegistryObject<Block> MANGO_SAPLING =
      BLOCKS.register(
          "mango_sapling", () -> new LionKingSaplingBlock(TreeGrowers.MANGO, saplingProperties()));

  public static final RegistryObject<Block> PASSION_SAPLING =
      BLOCKS.register(
          "passion_sapling",
          () ->
  ...
  public static final RegistryObject<Block> BANANA_SAPLING =
      BLOCKS.register(
          "banana_sapling",
          () -> new LionKingSaplingBlock(TreeGrowers.BANANA, saplingProperties()));

  // ========== Rafiki Wood ==========
  public static final RegistryObject<Block> RAFIKI_WOOD =
      BLOCKS.register(
          "rafiki_wood",
          () ->
              new RotatedPillarBlock(
  ...
  // ========== Waterlilies ==========
  public static final RegistryObject<Block> LILY_RED =
      BLOCKS.register(
          "lily_red",
          () ->
              new WaterlilyBlock(
  ...
  public static final RegistryObject<Block> LILY_VIOLET =
      BLOCKS.register(
          "lily_violet",
          () ->
              new WaterlilyBlock(
  ...
  public static final RegistryObject<Block> LILY_WHITE =
      BLOCKS.register(
          "lily_white",
          () ->
              new WaterlilyBlock(
  ...
  public static final RegistryObject<Block> OUTSHROOM_GLOWING =
      BLOCKS.register(
          "outshroom_glowing",
          () ->
              new MushroomBlock(
  ...
  // ========== Arid Grass ==========
  public static final RegistryObject<Block> ARID_GRASS =
      BLOCKS.register(
          "arid_grass",
          () ->
              new AridGrassBlock(
  ...
  // ========== Hyena Torch ==========
  public static final RegistryObject<Block> HYENA_TORCH =
      BLOCKS.register(
          "hyena_torch",
          () ->
              new TorchBlock(
  ...
  public static final RegistryObject<Block> HYENA_WALL_TORCH =
      BLOCKS.register(
          "hyena_wall_torch",
          () ->
              new WallTorchBlock(
  ...
  // ========== Hanging Banana ==========
  public static final RegistryObject<Block> HANGING_BANANA =
      BLOCKS.register(
          "hanging_banana",
          () ->
              new HangingBananaBlock(
                  BlockBehaviour.Properties.of()
                      .mapColor(MapColor.COLOR_YELLOW)
                      .instabreak()
                      .sound(SoundType.WOOD)
  ...
  public static final RegistryObject<Block> KIWANO_BLOCK =
      BLOCKS.register(
          "kiwano_block",
          () ->
              new Block(
  ...
  public static final RegistryObject<Block> HYENA_HEAD =
      BLOCKS.register(
          "hyena_head",
          () -> new HyenaHeadBlock(BlockBehaviour.Properties.of().strength(1.0F).noCollission()));

  public static final RegistryObject<Block> FUR_RUG =
      BLOCKS.register(
          "fur_rug",
          () ->
              new FurRugBlock(
  ...
  // ========== Grinding Bowl ==========
  public static final RegistryObject<Block> GRINDING_BOWL =
      BLOCKS.register(
          "grinding_bowl",
          () ->
              new GrindingBowlBlock(
                  BlockBehaviour.Properties.of()
                      .mapColor(MapColor.STONE)
                      .strength(2.0F)
                      .requiresCorrectToolForDrops()));
  ...
  // ========== Bug Trap ==========
  public static final RegistryObject<Block> BUG_TRAP =
      BLOCKS.register(
          "bug_trap",
          () ->
              new BugTrapBlock(
  ...
  // ========== Bongo Drum ==========
  public static final RegistryObject<Block> BONGO_DRUM =
      BLOCKS.register(
          "bongo_drum",
          () ->
              new BongoDrumBlock(
  ...
  // ========== Outlands Pool ==========
  public static final RegistryObject<Block> OUTLANDS_POOL =
      BLOCKS.register(
          "outlands_pool",
          () ->
              new OutlandsPoolBlock(
                  BlockBehaviour.Properties.of()
                      .mapColor(MapColor.COLOR_PURPLE)
  ...
  // ========== LK Spawner ==========
  public static final RegistryObject<Block> LK_SPAWNER =
      BLOCKS.register(
          "lk_spawner",
          () ->
              new SpawnerBlock(
  ...
  public static final RegistryObject<Block> BANANA_CAKE =
      BLOCKS.register(
          "banana_cake",
          () ->
              new BananaCakeBlock(
  ...
  public static final RegistryObject<Block> MOUNTED_SHOOTER =
      BLOCKS.register(
          "mounted_shooter",
          () ->
              new MountedShooterBlock(
                  BlockBehaviour.Properties.of()
                      .mapColor(MapColor.WOOD)
                      .strength(2.0F)
                      .sound(SoundType.WOOD)));

  public static final RegistryObject<Block> STAR_ALTAR =
      BLOCKS.register(
          "star_altar",
          () ->
              new StarAltarBlock(
  ...
  public static final RegistryObject<Block> OUTLANDS_ALTAR =
      BLOCKS.register(
          "outlands_altar",
          () ->
              new OutlandsAltarBlock(
                  BlockBehaviour.Properties.of()
                      .mapColor(MapColor.COLOR_PURPLE)
                      .strength(5.0F, 1200.0F)
                      .requiresCorrectToolForDrops()
  ...
  public static final RegistryObject<Block> TILLED_SAND =
      BLOCKS.register(
          "tilled_sand",
          () ->
              new TilledSandBlock(
  ...
  public static final RegistryObject<Block> VASE =
      BLOCKS.register(
          "vase",
          () ->
              new VaseBlock(
  ...
  // ========== Bed & Lever ==========
  public static final RegistryObject<BedBlock> PRIDE_BED =
      BLOCKS.register(
          "pride_bed",
          () ->
              new PrideBedBlock(
  ...
  public static final RegistryObject<LeverBlock> PRIDE_LEVER =
      BLOCKS.register(
          "pride_lever",
          () ->
              new LeverBlock(
  ...
  // ========== Portal Blocks ==========
  public static final RegistryObject<Block> PRIDE_PORTAL_FRAME =
      BLOCKS.register(
          "pride_portal_frame",
          () ->
  ...
  public static final RegistryObject<Block> OUTLANDS_PORTAL_FRAME =
      BLOCKS.register(
  ...
  public static final RegistryObject<Block> PRIDE_LANDS_PORTAL =
      BLOCKS.register(
          "pride_lands_portal",
          () ->
              new PortalBlock(
  ...
  public static final RegistryObject<Block> OUTLANDS_PORTAL =
      BLOCKS.register(
          "outlands_portal",
          () ->
              new PortalBlock(
