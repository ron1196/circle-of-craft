...
public class Enchantments {
  ...
  public static final RegistryObject<Enchantment> RAFIKI_DAMAGE =
  ...
  public static final RegistryObject<Enchantment> RAFIKI_DURABILITY =
      ENCHANTMENTS.register(
          "rafiki_durability",
          () ->
              new Enchantment(Enchantment.Rarity.UNCOMMON, RAFIKI_STICK_CATEGORY, MAINHAND) {
  ...
  public static final RegistryObject<Enchantment> RAFIKI_THUNDER =
      ENCHANTMENTS.register(
          "rafiki_thunder",
          () ->
  ...
  public static final RegistryObject<Enchantment> BIGGAH_DIGGAH =
      ENCHANTMENTS.register(
          "biggah_diggah",
          () ->
  ...
  public static final RegistryObject<Enchantment> PRECISION =
      ENCHANTMENTS.register(
          "precision",
          () ->
              new Enchantment(Enchantment.Rarity.COMMON, EnchantmentCategory.DIGGER, MAINHAND) {
