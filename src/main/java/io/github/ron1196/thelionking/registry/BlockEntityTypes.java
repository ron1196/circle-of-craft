...
public class BlockEntityTypes {
  ...
  public static final RegistryObject<BlockEntityType<HyenaHeadBlockEntity>> HYENA_HEAD =
      BLOCK_ENTITY_TYPES.register(
          "hyena_head",
          () ->
              BlockEntityType.Builder.of(HyenaHeadBlockEntity::new, LionKingBlocks.HYENA_HEAD.get())
                  .build(null));
  ...
  public static final RegistryObject<BlockEntityType<FurRugBlockEntity>> FUR_RUG =
      BLOCK_ENTITY_TYPES.register(
          "fur_rug",
          () ->
              BlockEntityType.Builder.of(FurRugBlockEntity::new, LionKingBlocks.FUR_RUG.get())
                  .build(null));
  ...
  public static final RegistryObject<BlockEntityType<BugTrapBlockEntity>> BUG_TRAP =
      BLOCK_ENTITY_TYPES.register(
          "bug_trap",
          () ->
              BlockEntityType.Builder.of(BugTrapBlockEntity::new, LionKingBlocks.BUG_TRAP.get())
                  .build(null));
  ...
  public static final RegistryObject<BlockEntityType<BongoDrumBlockEntity>> BONGO_DRUM =
      BLOCK_ENTITY_TYPES.register(
          "bongo_drum",
          () ->
              BlockEntityType.Builder.of(BongoDrumBlockEntity::new, LionKingBlocks.BONGO_DRUM.get())
                  .build(null));
  ...
  public static final RegistryObject<BlockEntityType<SpawnerBlockEntity>> LK_SPAWNER =
      BLOCK_ENTITY_TYPES.register(
          "lk_spawner",
          () ->
              BlockEntityType.Builder.of(SpawnerBlockEntity::new, LionKingBlocks.LK_SPAWNER.get())
                  .build(null));
  ...
  public static final RegistryObject<BlockEntityType<PrideBedBlockEntity>> PRIDE_BED =
      BLOCK_ENTITY_TYPES.register(
          "pride_bed",
          () ->
              BlockEntityType.Builder.of(PrideBedBlockEntity::new, LionKingBlocks.PRIDE_BED.get())
                  .build(null));
}
