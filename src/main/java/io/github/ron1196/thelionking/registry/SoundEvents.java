...
public class SoundEvents {
  ...
  // Crocodile sounds
  public static final RegistryObject<SoundEvent> CROCODILE_AMBIENT =
      register("entity.crocodile.ambient");
  public static final RegistryObject<SoundEvent> CROCODILE_SNAP = register("entity.crocodile.snap");
  public static final RegistryObject<SoundEvent> CROCODILE_DEATH =
      register("entity.crocodile.death");

  // Vulture sounds
  public static final RegistryObject<SoundEvent> VULTURE_AMBIENT =
      register("entity.vulture.ambient");
  public static final RegistryObject<SoundEvent> VULTURE_HURT = register("entity.vulture.hurt");

  // Rafiki Bird sounds
  public static final RegistryObject<SoundEvent> RAFIKI_BIRD_AMBIENT =
      register("entity.rafiki_bird.ambient");

  // Flamingo sounds
  public static final RegistryObject<SoundEvent> FLAMINGO_AMBIENT =
      register("entity.flamingo.ambient");
  ...
  // Music
  public static final RegistryObject<SoundEvent> MUSIC_CIRCLE_OF_LIFE =
      register("music.circle_of_life");
  public static final RegistryObject<SoundEvent> MUSIC_CANT_WAIT_TO_BE_KING =
  ...
  public static final RegistryObject<SoundEvent> MUSIC_HAKUNA_MATATA =
      register("music.hakuna_matata");
  ...
  private static RegistryObject<SoundEvent> register(String name) {
    return SOUND_EVENTS.register(
        name,
        () ->
            SoundEvent.createVariableRangeEvent(new ResourceLocation(TheLionKingMod.MOD_ID, name)));
  }
}
