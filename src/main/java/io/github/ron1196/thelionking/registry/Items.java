...
public class Items {
  ...
  public static final RegistryObject<Item> TERMITE_THROWN =
      ITEMS.register("termite_thrown", ThrownTermiteItem::new);
  ...
  public static final RegistryObject<Item> POISON =
      ITEMS.register("poison", () -> new Item(new Item.Properties()));
  ...
  public static final RegistryObject<Item> BUG =
      ITEMS.register("bug", () -> new Item(new Item.Properties()));

  public static final RegistryObject<Item> CRYSTAL =
      ITEMS.register("crystal", () -> new Item(new Item.Properties().stacksTo(16)));

  // ========== Food Items ==========
  public static final RegistryObject<Item> LION_RAW =
      ITEMS.register(
          "lion_raw",
          () ->
              new Item(
  ...
  public static final RegistryObject<Item> LION_COOKED =
      ITEMS.register(
          "lion_cooked",
          () ->
              new Item(
  ...
  public static final RegistryObject<Item> ZEBRA_RAW =
      ITEMS.register(
          "zebra_raw",
          () ->
              new Item(
  ...
  public static final RegistryObject<Item> ZEBRA_COOKED =
      ITEMS.register(
          "zebra_cooked",
          () ->
              new Item(
  ...
  public static final RegistryObject<Item> RHINO_RAW =
      ITEMS.register(
          "rhino_raw",
          () ->
              new Item(
  ...
  public static final RegistryObject<Item> RHINO_COOKED =
      ITEMS.register(
          "rhino_cooked",
          () ->
              new Item(
  ...
  public static final RegistryObject<Item> KIWANO =
      ITEMS.register(
          "kiwano",
          () ->
              new Item(
  ...
  public static final RegistryObject<Item> OUTLANDER_MEAT =
      ITEMS.register(
          "outlander_meat",
          () ->
              new Item(
  ...
  public static final RegistryObject<Item> CROCODILE_MEAT =
      ITEMS.register(
          "crocodile_meat",
          () ->
              new Item(
  ...
  public static final RegistryObject<Item> ROAST_YAM =
      ITEMS.register(
          "roast_yam",
          () ->
              new Item(
  ...
  public static final RegistryObject<Item> BANANA_BREAD =
      ITEMS.register(
          "banana_bread",
          () ->
              new Item(
  ...
  public static final RegistryObject<Item> CHOCOLATE_MUFASA =
      ITEMS.register(
          "chocolate_mufasa",
          () ->
              new Item(
  ...
  public static final RegistryObject<Item> BUG_STEW =
      ITEMS.register(
          "bug_stew",
          () ->
              new Item(
                  new Item.Properties()
                      .food(
                          new FoodProperties.Builder()
                              ...
                              .saturationMod(0.5F)
                              .effect(
                                  () -> new MobEffectInstance(MobEffects.CONFUSION, 160, 0), 0.4F)
                              .effect(() -> new MobEffectInstance(MobEffects.POISON, 60, 0), 0.12F)
                              .build())
                      .stacksTo(1)
                      .craftRemainder(net.minecraft.world.item.Items.BOWL)));

  public static final RegistryObject<Item> EXPERIENCE_GRUB =
      ITEMS.register(
          "experience_grub",
          () ->
              new io.github.ron1196.thelionking.item.ExperienceGrubItem(
                  new Item.Properties()
                      .food(
                          new FoodProperties.Builder()
                              .nutrition(0)
  ...
  // ========== Pridestone Tools ==========
  public static final RegistryObject<SwordItem> PRIDESTONE_SWORD =
      ITEMS.register(
          "pridestone_sword",
          () -> new SwordItem(LionKingToolTiers.PRIDESTONE, 3, -2.4F, new Item.Properties()));

  public static final RegistryObject<PickaxeItem> PRIDESTONE_PICKAXE =
      ITEMS.register(
          "pridestone_pickaxe",
          () -> new PickaxeItem(LionKingToolTiers.PRIDESTONE, 1, -2.8F, new Item.Properties()));

  public static final RegistryObject<AxeItem> PRIDESTONE_AXE =
      ITEMS.register(
          "pridestone_axe",
          () -> new AxeItem(LionKingToolTiers.PRIDESTONE, 6.0F, -3.1F, new Item.Properties()));

  public static final RegistryObject<ShovelItem> PRIDESTONE_SHOVEL =
      ITEMS.register(
          "pridestone_shovel",
          () -> new ShovelItem(LionKingToolTiers.PRIDESTONE, 1.5F, -3.0F, new Item.Properties()));

  public static final RegistryObject<HoeItem> PRIDESTONE_HOE =
      ITEMS.register(
          "pridestone_hoe",
          () -> new HoeItem(LionKingToolTiers.PRIDESTONE, -1, -2.0F, new Item.Properties()));

  // ========== Silver Tools ==========
  public static final RegistryObject<SwordItem> SILVER_SWORD =
      ITEMS.register(
          "silver_sword",
          () -> new SwordItem(LionKingToolTiers.SILVER, 3, -2.4F, new Item.Properties()));

  public static final RegistryObject<PickaxeItem> SILVER_PICKAXE =
      ITEMS.register(
          "silver_pickaxe",
          () -> new PickaxeItem(LionKingToolTiers.SILVER, 1, -2.8F, new Item.Properties()));

  public static final RegistryObject<AxeItem> SILVER_AXE =
      ITEMS.register(
          "silver_axe",
          () -> new AxeItem(LionKingToolTiers.SILVER, 6.0F, -3.1F, new Item.Properties()));

  public static final RegistryObject<ShovelItem> SILVER_SHOVEL =
      ITEMS.register(
          "silver_shovel",
          () -> new ShovelItem(LionKingToolTiers.SILVER, 1.5F, -3.0F, new Item.Properties()));

  public static final RegistryObject<HoeItem> SILVER_HOE =
      ITEMS.register(
          "silver_hoe",
          () -> new HoeItem(LionKingToolTiers.SILVER, -2, -1.0F, new Item.Properties()));

  // ========== Peacock Tools ==========
  public static final RegistryObject<SwordItem> PEACOCK_SWORD =
      ITEMS.register(
          "peacock_sword",
          () -> new SwordItem(LionKingToolTiers.PEACOCK, 3, -2.4F, new Item.Properties()));

  public static final RegistryObject<PickaxeItem> PEACOCK_PICKAXE =
      ITEMS.register(
          "peacock_pickaxe",
          () -> new PickaxeItem(LionKingToolTiers.PEACOCK, 1, -2.8F, new Item.Properties()));

  public static final RegistryObject<AxeItem> PEACOCK_AXE =
      ITEMS.register(
          "peacock_axe",
          () -> new AxeItem(LionKingToolTiers.PEACOCK, 5.0F, -3.0F, new Item.Properties()));

  public static final RegistryObject<ShovelItem> PEACOCK_SHOVEL =
      ITEMS.register(
          "peacock_shovel",
          () -> new ShovelItem(LionKingToolTiers.PEACOCK, 1.5F, -3.0F, new Item.Properties()));

  public static final RegistryObject<HoeItem> PEACOCK_HOE =
      ITEMS.register(
          "peacock_hoe",
          () -> new HoeItem(LionKingToolTiers.PEACOCK, -3, 0.0F, new Item.Properties()));

  // ========== Kivulite Tools ==========
  public static final RegistryObject<SwordItem> KIVULITE_SWORD =
      ITEMS.register(
          "kivulite_sword",
          () -> new KivuliteSwordItem(LionKingToolTiers.KIVULITE, 3, -2.4F, new Item.Properties()));
  public static final RegistryObject<PickaxeItem> KIVULITE_PICKAXE =
      ITEMS.register(
          "kivulite_pickaxe",
          () ->
              new KivulitePickaxeItem(LionKingToolTiers.KIVULITE, 1, -2.8F, new Item.Properties()));
  public static final RegistryObject<AxeItem> KIVULITE_AXE =
      ITEMS.register(
          "kivulite_axe",
          () ->
              new KivuliteAxeItem(LionKingToolTiers.KIVULITE, 6.0F, -3.1F, new Item.Properties()));
  public static final RegistryObject<ShovelItem> KIVULITE_SHOVEL =
      ITEMS.register(
          "kivulite_shovel",
          () ->
              new KivuliteShovelItem(
                  LionKingToolTiers.KIVULITE, 1.5F, -3.0F, new Item.Properties()));
  public static final RegistryObject<HoeItem> KIVULITE_HOE =
      ITEMS.register(
          "kivulite_hoe",
          () -> new HoeItem(LionKingToolTiers.KIVULITE, -2, -1.0F, new Item.Properties()));

  // ========== Corrupt Pridestone Tools ==========
  public static final RegistryObject<SwordItem> CORRUPT_SWORD =
      ITEMS.register(
          "corrupt_sword",
          () ->
              new SwordItem(LionKingToolTiers.CORRUPT_PRIDESTONE, 3, -2.4F, new Item.Properties()));
  public static final RegistryObject<PickaxeItem> CORRUPT_PICKAXE =
      ITEMS.register(
          "corrupt_pickaxe",
          () ->
              new PickaxeItem(
                  LionKingToolTiers.CORRUPT_PRIDESTONE, 1, -2.8F, new Item.Properties()));
  public static final RegistryObject<AxeItem> CORRUPT_AXE =
      ITEMS.register(
          "corrupt_axe",
          () ->
              new AxeItem(
                  LionKingToolTiers.CORRUPT_PRIDESTONE, 6.0F, -3.1F, new Item.Properties()));
  public static final RegistryObject<ShovelItem> CORRUPT_SHOVEL =
      ITEMS.register(
          "corrupt_shovel",
          () ->
              new ShovelItem(
                  LionKingToolTiers.CORRUPT_PRIDESTONE, 1.5F, -3.0F, new Item.Properties()));
  public static final RegistryObject<HoeItem> CORRUPT_HOE =
      ITEMS.register(
          "corrupt_hoe",
          () ->
              new HoeItem(LionKingToolTiers.CORRUPT_PRIDESTONE, -1, -2.0F, new Item.Properties()));
  ...
  public static final RegistryObject<ArmorItem> SILVER_HELMET =
      ITEMS.register(
          ...
          () ->
              new ArmorItem(
                  LionKingArmorMaterials.SILVER, ArmorItem.Type.HELMET, new Item.Properties()));
  ...
  public static final RegistryObject<ArmorItem> SILVER_CHESTPLATE =
      ITEMS.register(
          ...
          () ->
              new ArmorItem(
                  LionKingArmorMaterials.SILVER, ArmorItem.Type.CHESTPLATE, new Item.Properties()));
  ...
  public static final RegistryObject<ArmorItem> SILVER_LEGGINGS =
      ITEMS.register(
          ...
          () ->
              new ArmorItem(
                  LionKingArmorMaterials.SILVER, ArmorItem.Type.LEGGINGS, new Item.Properties()));
  ...
  public static final RegistryObject<ArmorItem> SILVER_BOOTS =
      ITEMS.register(
          ...
          () ->
              new ArmorItem(
                  LionKingArmorMaterials.SILVER, ArmorItem.Type.BOOTS, new Item.Properties()));
  ...
  public static final RegistryObject<ArmorItem> GEMSBOK_HELMET =
      ITEMS.register(
          ...
          () ->
              new ArmorItem(
                  LionKingArmorMaterials.GEMSBOK, ArmorItem.Type.HELMET, new Item.Properties()));
  ...
  public static final RegistryObject<ArmorItem> GEMSBOK_LEGGINGS =
      ITEMS.register(
          ...
          () ->
              new ArmorItem(
                  LionKingArmorMaterials.GEMSBOK, ArmorItem.Type.LEGGINGS, new Item.Properties()));
  ...
  public static final RegistryObject<ArmorItem> GEMSBOK_BOOTS =
      ITEMS.register(
          ...
          () ->
              new ArmorItem(
                  LionKingArmorMaterials.GEMSBOK, ArmorItem.Type.BOOTS, new Item.Properties()));
  ...
  public static final RegistryObject<ArmorItem> PEACOCK_HELMET =
      ITEMS.register(
          ...
          () ->
              new ArmorItem(
                  LionKingArmorMaterials.PEACOCK, ArmorItem.Type.HELMET, new Item.Properties()));
  ...
  public static final RegistryObject<ArmorItem> PEACOCK_CHESTPLATE =
      ITEMS.register(
          ...
          () ->
              new ArmorItem(
                  LionKingArmorMaterials.PEACOCK,
                  ArmorItem.Type.CHESTPLATE,
                  new Item.Properties()));
  ...
  public static final RegistryObject<ArmorItem> PEACOCK_LEGGINGS =
      ITEMS.register(
          ...
          () ->
              new ArmorItem(
                  LionKingArmorMaterials.PEACOCK, ArmorItem.Type.LEGGINGS, new Item.Properties()));
  ...
  public static final RegistryObject<ArmorItem> PEACOCK_BOOTS =
      ITEMS.register(
          ...
          () ->
              new ArmorItem(
                  LionKingArmorMaterials.PEACOCK, ArmorItem.Type.BOOTS, new Item.Properties()));
  ...
  public static final RegistryObject<BlockItem> OUTSAND_ITEM =
      registerBlockItem("outsand", LionKingBlocks.OUTSAND);
  ...
  public static final RegistryObject<BlockItem> LILY_RED_ITEM =
      ITEMS.register(
          "lily_red", () -> new LilyPadItem(LionKingBlocks.LILY_RED.get(), new Item.Properties()));
  public static final RegistryObject<BlockItem> LILY_VIOLET_ITEM =
      ITEMS.register(
          "lily_violet",
          () -> new LilyPadItem(LionKingBlocks.LILY_VIOLET.get(), new Item.Properties()));
  public static final RegistryObject<BlockItem> LILY_WHITE_ITEM =
      ITEMS.register(
          "lily_white",
          () -> new LilyPadItem(LionKingBlocks.LILY_WHITE.get(), new Item.Properties()));
  ...
  // Crop seeds
  public static final RegistryObject<Item> KIWANO_SEEDS =
      ITEMS.register(
          "kiwano_seeds",
          () ->
  ...
  public static final RegistryObject<Item> YAM =
      ITEMS.register(
          ...
          () ->
              new net.minecraft.world.item.ItemNameBlockItem(
                  LionKingBlocks.YAM_CROP.get(), new Item.Properties()));

  public static final RegistryObject<Item> MAIZE_STALKS =
      ITEMS.register(
          "maize_stalks",
          () ->
              new net.minecraft.world.item.ItemNameBlockItem(
  ...
  public static final RegistryObject<BlockItem> HYENA_HEAD_ITEM =
      ITEMS.register(
          "hyena_head",
          () ->
              new io.github.ron1196.thelionking.item.HyenaHeadBlockItem(
                  LionKingBlocks.HYENA_HEAD.get(), new Item.Properties()));
  public static final RegistryObject<BlockItem> FUR_RUG_ITEM =
      registerBlockItem("fur_rug", LionKingBlocks.FUR_RUG);
  ...
  public static final RegistryObject<ArmorItem> OUTLANDS_HELMET =
      ITEMS.register(
          ...
          () ->
              new ArmorItem(
                  LionKingArmorMaterials.OUTLANDS, ArmorItem.Type.HELMET, new Item.Properties()));
  ...
  public static final RegistryObject<ArmorItem> TICKET_LION_HEAD =
      ITEMS.register(
          ...
          () ->
              new ArmorItem(
                  LionKingArmorMaterials.TICKET_LION,
  ...
  public static final RegistryObject<ArmorItem> TICKET_LION_FEET =
      ITEMS.register(
          ...
          () ->
              new ArmorItem(
                  LionKingArmorMaterials.TICKET_LION, ArmorItem.Type.BOOTS, new Item.Properties()));
  ...
  // ========== Bombs ==========
  public static final RegistryObject<Item> PUMBAA_BOMB =
      ITEMS.register("pumbaa_bomb", PumbaaBombItem::new);
  ...
  public static final RegistryObject<Item> LIONESS_SPAWN_EGG =
      ITEMS.register(
          "lioness_spawn_egg",
          () ->
              new ForgeSpawnEggItem(
                  EntityTypes.LIONESS, 0xD4A030, 0xC8A848, new Item.Properties()));
  public static final RegistryObject<Item> ZEBRA_SPAWN_EGG =
      ITEMS.register(
          "zebra_spawn_egg",
          () ->
  ...
  public static final RegistryObject<Item> GIRAFFE_SPAWN_EGG =
      ITEMS.register(
          ...
          () ->
              new ForgeSpawnEggItem(
                  EntityTypes.GIRAFFE, 0xE8B84B, 0x8B5E3C, new Item.Properties()));
  ...
  public static final RegistryObject<Item> GEMSBOK_SPAWN_EGG =
      ITEMS.register(
          "gemsbok_spawn_egg",
          () ->
              new ForgeSpawnEggItem(
                  EntityTypes.GEMSBOK, 0xC8A878, 0x4A3B2A, new Item.Properties()));
  public static final RegistryObject<Item> DIKDIK_SPAWN_EGG =
      ITEMS.register(
          "dikdik_spawn_egg",
          () ->
  ...
  public static final RegistryObject<Item> FLAMINGO_SPAWN_EGG =
      ITEMS.register(
          ...
          () ->
              new ForgeSpawnEggItem(
                  EntityTypes.FLAMINGO, 0xFF69B4, 0xFF1493, new Item.Properties()));
  public static final RegistryObject<Item> ZAZU_SPAWN_EGG =
      ITEMS.register(
          "zazu_spawn_egg",
          () -> new ForgeSpawnEggItem(EntityTypes.ZAZU, 0x4169E1, 0xFFD700, new Item.Properties()));
  public static final RegistryObject<Item> BUG_SPAWN_EGG =
      ITEMS.register(
          "bug_spawn_egg",
          () -> new ForgeSpawnEggItem(EntityTypes.BUG, 0x4B3621, 0x2E1F0F, new Item.Properties()));

  // ========== Phase 4: Hostile Spawn Eggs ==========
  public static final RegistryObject<Item> HYENA_SPAWN_EGG =
      ITEMS.register(
          "hyena_spawn_egg",
          () ->
  ...
  public static final RegistryObject<Item> SKELETAL_HYENA_SPAWN_EGG =
      ITEMS.register(
          ...
          () ->
              new ForgeSpawnEggItem(
                  EntityTypes.SKELETAL_HYENA, 0xC8C8C8, 0x505050, new Item.Properties()));
  public static final RegistryObject<Item> OUTLANDER_SPAWN_EGG =
      ITEMS.register(
          "outlander_spawn_egg",
          () ->
              new ForgeSpawnEggItem(
                  EntityTypes.OUTLANDER, 0x5C3A1E, 0x3A2510, new Item.Properties()));
  public static final RegistryObject<Item> VULTURE_SPAWN_EGG =
      ITEMS.register(
          "vulture_spawn_egg",
          () ->
              new ForgeSpawnEggItem(
                  EntityTypes.VULTURE, 0x2A1F14, 0x8B0000, new Item.Properties()));
  public static final RegistryObject<Item> CROCODILE_SPAWN_EGG =
      ITEMS.register(
          "crocodile_spawn_egg",
          () ->
              new ForgeSpawnEggItem(
                  EntityTypes.CROCODILE, 0x3B5323, 0x1A2E0A, new Item.Properties()));
  public static final RegistryObject<Item> TERMITE_SPAWN_EGG =
      ITEMS.register(
          "termite_spawn_egg",
          () ->
              new ForgeSpawnEggItem(
                  EntityTypes.TERMITE, 0xD2B48C, 0x8B6914, new Item.Properties()));
  public static final RegistryObject<Item> TERMITE_QUEEN_SPAWN_EGG =
      ITEMS.register(
          "termite_queen_spawn_egg",
          () ->
              new ForgeSpawnEggItem(
                  EntityTypes.TERMITE_QUEEN, 0xD2B48C, 0xFF4500, new Item.Properties()));
  ...
  public static final RegistryObject<Item> TICKET_LION_SPAWN_EGG =
      ITEMS.register(
          ...
          () ->
              new ForgeSpawnEggItem(
                  EntityTypes.TICKET_LION, 0xD4A030, 0x4169E1, new Item.Properties()));

  // ========== NPC Spawn Eggs ==========
  public static final RegistryObject<Item> RAFIKI_SPAWN_EGG =
      ITEMS.register(
          "rafiki_spawn_egg",
          () ->
              new ForgeSpawnEggItem(EntityTypes.RAFIKI, 0x8B4513, 0xFFD700, new Item.Properties()));
  public static final RegistryObject<Item> SIMBA_SPAWN_EGG =
      ITEMS.register(
          "simba_spawn_egg",
          () ->
              new ForgeSpawnEggItem(EntityTypes.SIMBA, 0xD4A030, 0xFFD700, new Item.Properties()));
  public static final RegistryObject<Item> TIMON_SPAWN_EGG =
      ITEMS.register(
          "timon_spawn_egg",
          () ->
              new ForgeSpawnEggItem(EntityTypes.TIMON, 0xB8860B, 0xFFE4B5, new Item.Properties()));
  public static final RegistryObject<Item> PUMBAA_SPAWN_EGG =
      ITEMS.register(
          "pumbaa_spawn_egg",
          () ->
              new ForgeSpawnEggItem(EntityTypes.PUMBAA, 0x8B4513, 0x654321, new Item.Properties()));
  public static final RegistryObject<Item> SCAR_SPAWN_EGG =
      ITEMS.register(
          "scar_spawn_egg",
          () -> new ForgeSpawnEggItem(EntityTypes.SCAR, 0x2F1A00, 0x000000, new Item.Properties()));
  public static final RegistryObject<Item> ZIRA_SPAWN_EGG =
      ITEMS.register(
          "zira_spawn_egg",
  ...
  public static final RegistryObject<Item> JAR_LAVA =
      ITEMS.register(
          "jar_lava",
          () -> new Item(new Item.Properties().stacksTo(16).craftRemainder(JAR_EMPTY.get())));
  public static final RegistryObject<Item> MANGO_JUICE =
      ITEMS.register(
          "mango_juice",
          () ->
              new Item(
  ...
  // ========== Tunnah Diggah ==========
  public static final RegistryObject<Item> TUNNAH_DIGGAH =
      ITEMS.register(
          "tunnah_diggah",
          () -> new TunnahDiggahItem(Tiers.IRON, 1, -2.8F, new Item.Properties().durability(690)));

  // ========== Quest & Special Items ==========
  public static final RegistryObject<Item> AMULET =
      ITEMS.register("amulet", () -> new Item(new Item.Properties().stacksTo(1)));
  public static final RegistryObject<Item> SIMBA_CHARM =
      ITEMS.register(
          "simba_charm",
  ...
  public static final RegistryObject<Item> PASSION_FRUIT =
      ITEMS.register(
          "passion_fruit",
          () ->
              new Item(
  ...
  public static final RegistryObject<Item> TICKET =
      ITEMS.register(
          "ticket", () -> new io.github.ron1196.thelionking.item.TicketItem(new Item.Properties()));
  ...
  public static final RegistryObject<Item> RAFIKI_STICK =
      ITEMS.register(
          "rafiki_stick",
          () -> new io.github.ron1196.thelionking.item.RafikiStickItem(new Item.Properties()));

  public static final RegistryObject<Item> RAFIKI_DUST =
      ITEMS.register(
          "rafiki_dust",
  ...
  public static final RegistryObject<BlockItem> VASE_ITEM =
      registerBlockItem("vase", LionKingBlocks.VASE);

  // ========== Bed & Lever ==========
  public static final RegistryObject<BlockItem> PRIDE_BED_ITEM =
      ITEMS.register(
          "pride_bed",
          () -> new BedItem(LionKingBlocks.PRIDE_BED.get(), new Item.Properties().stacksTo(1)));
  ...
  public static final RegistryObject<Item> SCAR_RUG =
      ITEMS.register(
          "scar_rug", () -> new RugItem(RugEntity.TYPE_SCAR, new Item.Properties().stacksTo(1)));
  public static final RegistryObject<Item> ZIRA_RUG =
      ITEMS.register(
          "zira_rug", () -> new RugItem(RugEntity.TYPE_ZIRA, new Item.Properties().stacksTo(1)));
  ...
  public static final RegistryObject<Item> SKELETAL_HYENA_HEAD_SPAWN_EGG =
      ITEMS.register(
          ...
          () ->
              new ForgeSpawnEggItem(
                  EntityTypes.SKELETAL_HYENA_HEAD, 0xC8C8C8, 0x3A3A3A, new Item.Properties()));
