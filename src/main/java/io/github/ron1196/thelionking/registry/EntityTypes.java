...
public class EntityTypes {
  ...
  public static final RegistryObject<EntityType<TermiteThrownEntity>> TERMITE_THROWN =
      ENTITY_TYPES.register(
          "termite_thrown",
          () ->
              EntityType.Builder.<TermiteThrownEntity>of(TermiteThrownEntity::new, MobCategory.MISC)
                  .sized(0.25F, 0.25F)
                  .clientTrackingRange(4)
                  .updateInterval(10)
  ...
  public static final RegistryObject<
          EntityType<io.github.ron1196.thelionking.entity.npc.TicketLionEntity>>
      TICKET_LION =
          ENTITY_TYPES.register(
              "ticket_lion",
              () ->
                  EntityType.Builder.of(
                          io.github.ron1196.thelionking.entity.npc.TicketLionEntity::new,
  ...
  public static final RegistryObject<EntityType<LightningBoltEntity>> LK_LIGHTNING_BOLT =
      ENTITY_TYPES.register(
          "lk_lightning_bolt",
          () ->
              (EntityType<LightningBoltEntity>)
                  (EntityType<?>)
                      EntityType.Builder.<LightningBolt>of(
