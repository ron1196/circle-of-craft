...
public class TimonModel extends EntityModel<Mob> {
  ...
  public static LayerDefinition createBodyLayer() {
    ...
    PartDefinition headPart =
        root.addOrReplaceChild(
            ...
            CubeListBuilder.create()
                .texOffs(0, 0)
                .addBox(-4.0F, -8.0F, -4.0F, 8, 7, 6)
                .texOffs(46, 7)
                .addBox(-3.5F, -9.0F, -2.0F, 7, 1, 2)
                .texOffs(0, 0)
                .addBox(-1.0F, -5.0F, -5.0F, 2, 2, 1),
    ...
    root.addOrReplaceChild(
        ...
        CubeListBuilder.create()
            .texOffs(0, 13)
            .addBox(-2.0F, 0.0F, -2.0F, 3, 9, 3)
            .texOffs(44, 0)
            .addBox(-2.7F, 8.0F, -3.9F, 4, 1, 6),
