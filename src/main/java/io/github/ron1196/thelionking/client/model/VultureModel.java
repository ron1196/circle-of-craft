    ...
    public static LayerDefinition createBodyLayer() {
        ...
        root.addOrReplaceChild("body",
                CubeListBuilder.create().texOffs(0, 46)
                        .addBox(0.0F, 0.0F, 0.0F, 8.0F, 10.0F, 8.0F),
        ...
        root.addOrReplaceChild("leg_left",
                CubeListBuilder.create().texOffs(40, 0)
                        .addBox(0.0F, 0.0F, 0.0F, 2.0F, 12.0F, 2.0F),
        ...
        root.addOrReplaceChild("head",
                CubeListBuilder.create()
                        .texOffs(0, 0).addBox(-3.0F, -2.0F, -3.0F, 6.0F, 6.0F, 6.0F)
                        .texOffs(28, 0).addBox(-1.5F, 1.5F, -6.9F, 3.0F, 2.0F, 2.0F)
                        .texOffs(46, 29).addBox(-2.0F, 0.5F, -7.0F, 4.0F, 2.0F, 5.0F),
                PartPose.offset(0.5F, 0.0F, -2.5F));

        root.addOrReplaceChild("wing_left",
                CubeListBuilder.create().texOffs(0, 26)
                        .addBox(0.0F, 0.0F, 0.0F, 2.0F, 10.0F, 7.0F),
                PartPose.offset(4.0F, 5.0F, -2.0F));

        root.addOrReplaceChild("wing_right",
                CubeListBuilder.create().texOffs(0, 26).mirror()
                        .addBox(-2.0F, 0.0F, 0.0F, 2.0F, 10.0F, 7.0F),
                PartPose.offset(-4.0F, 5.0F, -2.0F));
