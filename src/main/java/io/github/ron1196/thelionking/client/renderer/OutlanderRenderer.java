...
public class OutlanderRenderer
    extends net.minecraft.client.renderer.entity.MobRenderer<
        OutlanderEntity, OutlanderModel<OutlanderEntity>> {
  ...
  public OutlanderRenderer(
      EntityRendererProvider.Context context, OutlanderModel<OutlanderEntity> model) {
