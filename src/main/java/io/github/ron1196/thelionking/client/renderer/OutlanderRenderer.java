...
public class OutlanderRenderer extends net.minecraft.client.renderer.entity.MobRenderer<OutlanderEntity, OutlanderModel<OutlanderEntity>> {

    private static final ResourceLocation MALE_TEXTURE = new ResourceLocation(
            TheLionKingMod.MOD_ID,
            "textures/entity/outlander_male.png"
    );
    private static final ResourceLocation FEMALE_TEXTURE = new ResourceLocation(
            TheLionKingMod.MOD_ID,
            "textures/entity/outlander_female.png"
    );
