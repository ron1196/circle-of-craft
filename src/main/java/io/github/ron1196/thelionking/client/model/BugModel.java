...
public class BugModel<T extends LKAnimal> extends EntityModel<T> {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        root.addOrReplaceChild("leg_left1",
                CubeListBuilder.create().texOffs(0, 14)
                        .addBox(-0.5F, 0.0F, -0.5F, 1.0F, 2.0F, 1.0F),
                PartPose.offset(-2.0F, 22.0F, -1.0F));
        root.addOrReplaceChild("leg_right1",
                CubeListBuilder.create().texOffs(0, 14)
                        .addBox(-0.5F, 0.0F, -0.5F, 1.0F, 2.0F, 1.0F),
                PartPose.offset(2.0F, 22.0F, -1.0F));
        root.addOrReplaceChild("leg_left2",
                CubeListBuilder.create().texOffs(0, 14)
                        .addBox(-0.5F, 0.0F, -0.5F, 1.0F, 2.0F, 1.0F),
                PartPose.offset(-2.0F, 22.0F, 1.0F));
        root.addOrReplaceChild("leg_right2",
                CubeListBuilder.create().texOffs(0, 14)
                        .addBox(-0.5F, 0.0F, -0.5F, 1.0F, 2.0F, 1.0F),
                PartPose.offset(2.0F, 22.0F, 1.0F));
