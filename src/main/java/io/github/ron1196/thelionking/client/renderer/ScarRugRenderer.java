...
import io.github.ron1196.thelionking.client.model.ScarRugModel;
...
public class ScarRugRenderer extends EntityRenderer<ScarRugEntity> {
    ...
    private final ScarRugModel model;

    public ScarRugRenderer(EntityRendererProvider.Context context, ScarRugModel model) {
        super(context);
        this.model = model;
    }

    @Override
    public void render(@NotNull ScarRugEntity entity, float entityYaw, float partialTick,
    ...
    @Override
    public @NotNull ResourceLocation getTextureLocation(@NotNull ScarRugEntity entity) {
        return entity.getRugType() == ScarRugEntity.TYPE_ZIRA ? TEXTURE_ZIRA : TEXTURE_SCAR;
    }
}
