...
public class FlamingoModel<T extends LionKingAnimal> extends EntityModel<T> {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        root.addOrReplaceChild("head",
                CubeListBuilder.create()
                        .texOffs(8, 24).addBox(-2.0F, -17.0F, -2.0F, 4.0F, 4.0F, 4.0F)
                        .texOffs(24, 27).addBox(-1.5F, -16.0F, -5.0F, 3.0F, 2.0F, 3.0F)
                        .texOffs(36, 30).addBox(-1.0F, -14.0F, -5.0F, 2.0F, 1.0F, 1.0F)
                        .texOffs(0, 16).addBox(-1.0F, -15.0F, -1.0F, 2.0F, 14.0F, 2.0F),
                PartPose.offset(0.0F, 5.0F, -2.0F));

        // Body
        root.addOrReplaceChild("body",
                CubeListBuilder.create()
                        .texOffs(0, 0).addBox(-3.0F, 0.0F, -4.0F, 6.0F, 7.0F, 8.0F),
                PartPose.offset(0.0F, 3.0F, 0.0F));

        // Tail
        root.addOrReplaceChild("tail",
                CubeListBuilder.create()
                        .texOffs(42, 23).addBox(-2.5F, 0.0F, 0.0F, 5.0F, 3.0F, 6.0F),
                PartPose.offsetAndRotation(0.0F, 4.0F, 3.0F, -0.25F, 0.0F, 0.0F));

        // Wings
        root.addOrReplaceChild("wing_left",
                CubeListBuilder.create()
                        .texOffs(36, 0).addBox(-1.0F, 0.0F, -3.0F, 1.0F, 8.0F, 6.0F),
                PartPose.offset(-3.0F, 3.0F, 0.0F));

        root.addOrReplaceChild("wing_right",
                CubeListBuilder.create()
                        .texOffs(50, 0).addBox(0.0F, 0.0F, -3.0F, 1.0F, 8.0F, 6.0F),
                PartPose.offset(3.0F, 3.0F, 0.0F));

        // Legs with feet
        root.addOrReplaceChild("leg_left",
                CubeListBuilder.create()
                        .texOffs(30, 0).addBox(-0.5F, 0.0F, -0.5F, 1.0F, 16.0F, 1.0F)
                        .texOffs(30, 17).addBox(-1.5F, 14.9F, -3.5F, 3.0F, 1.0F, 3.0F),
