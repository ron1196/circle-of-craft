...
public class DikDikModel<T extends LKAnimal> extends EntityModel<T> {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        root.addOrReplaceChild("head",
                CubeListBuilder.create()
                        // head
                        .texOffs(42, 23).addBox(-2.0F, -9.0F, -3.0F, 4.0F, 4.0F, 5.0F)
                        // snout
                        .texOffs(18, 28).addBox(-1.0F, -7.3F, -5.0F, 2.0F, 2.0F, 2.0F)
                        // earL
                        .texOffs(0, 27).addBox(-2.8F, -11.0F, 0.5F, 1.0F, 3.0F, 2.0F)
                        // earR
                        .texOffs(8, 27).addBox(1.8F, -11.0F, 0.5F, 1.0F, 3.0F, 2.0F)
                        // hornL
                        .texOffs(0, 21).addBox(-1.5F, -11.0F, 0.0F, 1.0F, 2.0F, 1.0F)
                        // hornR
                        .texOffs(0, 21).addBox(0.5F, -11.0F, 0.0F, 1.0F, 2.0F, 1.0F)
                        // neck
                        .texOffs(28, 22).addBox(-1.5F, -8.0F, -2.0F, 3.0F, 7.0F, 3.0F),
                PartPose.offset(0.0F, 11.0F, -4.5F));

        root.addOrReplaceChild("body",
                CubeListBuilder.create()
                        .texOffs(0, 0).addBox(-3.0F, 0.0F, 0.0F, 6.0F, 6.0F, 14.0F),
                PartPose.offset(0.0F, 9.0F, -7.0F));

        root.addOrReplaceChild("leg1",
                CubeListBuilder.create()
                        .texOffs(56, 0).addBox(-1.0F, 0.0F, -1.0F, 2.0F, 10.0F, 2.0F),
