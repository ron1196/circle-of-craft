...
public class CrocodileModel<T extends Mob> extends EntityModel<T> {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        root.addOrReplaceChild("leg_front_left",
                CubeListBuilder.create().texOffs(2, 104)
                        .addBox(0.0F, 0.0F, -3.0F, 16.0F, 3.0F, 6.0F),
                PartPose.offsetAndRotation(6.0F, 15.0F, -11.0F,
                        0.0F, 0.0F, 0.4363F));

        root.addOrReplaceChild("leg_back_left",
                CubeListBuilder.create().texOffs(2, 104)
                        .addBox(0.0F, 0.0F, -3.0F, 16.0F, 3.0F, 6.0F),
                PartPose.offsetAndRotation(6.0F, 15.0F, 15.0F,
                        0.0F, 0.0F, 0.4363F));

        root.addOrReplaceChild("leg_front_right",
                CubeListBuilder.create().texOffs(2, 104).mirror()
                        .addBox(-16.0F, 0.0F, -3.0F, 16.0F, 3.0F, 6.0F),
                PartPose.offsetAndRotation(-6.0F, 15.0F, -11.0F,
                        0.0F, 0.0F, -0.4363F));
        ...
        root.addOrReplaceChild("spines",
                CubeListBuilder.create().texOffs(46, 45)
                        .addBox(-5.0F, 0.0F, 0.0F, 10.0F, 4.0F, 32.0F),
                PartPose.offsetAndRotation(0.0F, 9.5F, -14.0F,
                        -0.0349F, 0.0F, 0.0F));
