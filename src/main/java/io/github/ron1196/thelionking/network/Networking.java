...
public class Networking {
  ...
  public static void register() {
    ...
    CHANNEL
        .messageBuilder(SimbaSitPacket.class, id(), NetworkDirection.PLAY_TO_SERVER)
    ...
    CHANNEL
        .messageBuilder(QuestSyncPacket.class, id(), NetworkDirection.PLAY_TO_CLIENT)
    ...
    CHANNEL
        .messageBuilder(QuestCheckPacket.class, id(), NetworkDirection.PLAY_TO_SERVER)
    ...
    CHANNEL
        .messageBuilder(LoginSyncPacket.class, id(), NetworkDirection.PLAY_TO_CLIENT)
    ...
    CHANNEL
        .messageBuilder(PlayerDataSyncPacket.class, id(), NetworkDirection.PLAY_TO_CLIENT)
    ...
    CHANNEL
        .messageBuilder(FlatulencePacket.class, id(), NetworkDirection.PLAY_TO_CLIENT)
