...
public enum TermiteQueenProvider implements IEntityComponentProvider, IServerDataProvider<EntityAccessor> {
    ...
    public static final ResourceLocation UID = new ResourceLocation(TheLionKingMod.MOD_ID, "termite_queen");
    ...
    public void appendTooltip(
        ...
        tooltip.add(Component.translatable("jade.thelionking.termite_queen.hp", hpPct));
        ...
        tooltip.add(Component.translatable(
                "jade.thelionking.termite_queen.minions", nearby, TermiteQueenEntity.MAX_NEARBY_TERMITES));
        ...
        if (data.contains(NBT_SPAWN_COOLDOWN) && queen.getTarget() != null) {
            ...
            if (cooldownTicks > 0) {
                ...
                tooltip.add(Component.translatable("jade.thelionking.termite_queen.next_spawn", seconds));
            }
        }

        for (Entity passenger : queen.getPassengers()) {
            if (passenger instanceof ZiraEntity) {
                tooltip.add(Component.translatable("jade.thelionking.termite_queen.zira_mounted")
