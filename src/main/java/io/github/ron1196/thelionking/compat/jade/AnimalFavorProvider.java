...
public enum AnimalFavorProvider implements IEntityComponentProvider, IServerDataProvider<EntityAccessor> {
    ...
    public static final ResourceLocation UID = new ResourceLocation(TheLionKingMod.MOD_ID, "animal_favor");
    ...
    public void appendTooltip(
        ...
        tooltip.add(Component.translatable("jade.thelionking.animal_favor.wants", amount, item.getDescription())
                .withStyle(ChatFormatting.GOLD));
    }

    @Override
    public void appendServerData(@NotNull CompoundTag data, @NotNull EntityAccessor accessor) {
        if (!(accessor.getEntity() instanceof LionKingAnimal animal)) {
            return;
        }
