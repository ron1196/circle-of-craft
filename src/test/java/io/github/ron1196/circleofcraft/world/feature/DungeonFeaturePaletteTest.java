...
class DungeonFeaturePaletteTest {
    ...
    void outlandsDimensionMapsToCorruptPalette() {
        assertEquals(DungeonPalette.OUTLANDS, DungeonPalette.forDimension(CircleOfCraftMod.id("outlands")));
    }

    @Test
    void prideLandsMapsToPridePalette() {
        assertEquals(DungeonPalette.PRIDE, DungeonPalette.forDimension(CircleOfCraftMod.id("pride_lands")));
    }
    ...
    void upendiFallsBackToPridePalette() {
        ...
        assertEquals(DungeonPalette.PRIDE, DungeonPalette.forDimension(CircleOfCraftMod.id("upendi")));
    }
